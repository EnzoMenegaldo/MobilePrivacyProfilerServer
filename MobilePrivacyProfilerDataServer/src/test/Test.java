...
import fr.inria.diverse.mobileprivacyprofilerserver.database.user.data.ApplicationHistory;
import fr.inria.diverse.mobileprivacyprofilerserver.database.user.data.MobilePrivacyProfilerDBHelper;
