/*  */
package fr.inria.diverse.mobileprivacyprofilerserver.database.data.xml;
...
/**
 * Root XmlPullParser for parsing the fr.inria.diverse.mobileprivacyprofilerserver.database.user.data MobilePrivacyProfilerDB
 */
